...
def get_bert_layer_representations(seq_len, text_array, remove_chars, word_ind_to_extract,feature_strategy,home_path):
    ...
    for _ in range(seq_len):
        BERT = add_avrg_token_embedding_for_specific_word(word_seq,
                                                                     ...
                                                                     BERT,feature_strategy,home_path)
...
def add_avrg_token_embedding_for_specific_word(word_seq,tokenizer,model,remove_chars,from_start_word_ind_to_extract,bert_dict,feature_strategy,home_path):
    
    word_seq = ['[CLS]'] + list(word_seq) + ['[SEP]']
    all_sequence_embeddings, word_ind_to_token_ind, _ = predict_bertlike_embeddings(word_seq, tokenizer, model, remove_chars,feature_strategy,home_path)
